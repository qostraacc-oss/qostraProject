...
class WorkspaceMappingTestCase(TestCase):
    ...
    def test_workspace_mapping_and_isolation(self):
        ...
        accept_url = reverse(
            "project-invitation-accept", kwargs={"invitation_id": invite.id}
        )
        ...
        list_url_mapped = reverse(
            "project-list-create",
            kwargs={"workspace_id": self.invitee_workspace_mapped},
        )
        ...
        list_url_other = reverse(
            "project-list-create", kwargs={"workspace_id": self.invitee_workspace_other}
        )
        ...
        board_url_mapped = reverse(
            "board-detail",
            kwargs={
                "workspace_id": self.invitee_workspace_mapped,
        ...
        board_url_other = reverse(
            "board-detail",
            kwargs={
                "workspace_id": self.invitee_workspace_other,
                "board_id": self.board.id,
            },
        )
